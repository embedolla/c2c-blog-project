...
const uri = 'mongodb+srv://emilyebedolla:rXUM9xrsLfYBaw9u@c2c-blog-cluster.snxyxga.mongodb.net/c2c-blog?appName=c2c-blog-cluster';

const samplePosts = [
    {
    title: "My First Blog Post",
    slug: "my-first-post",
    excerpt: "This is where my journey begins.",
...
},
{
    ...
    excerpt: "A deep dive into the App Router and server components.",
...
},
{
    ...
    excerpt: "A beginner's guide to NoSQL databases.",
